...
#### 1. Reorder factors based on another **numerical variable** {.unnumbered}
...
#### 2. Reorder factors **manually** {.unnumbered}
...
#### 2. Reorder factors **manually** with `fct_relevel()`{.unnumbered}
...
#### 3. Modify factors manually {.unnumbered}
...
#### 3. Modify factors manually with `fct_recode()` {.unnumbered}
...
#### 2 & 3. Modify and reorder factors manually {.unnumbered}
...
#### 4. What if there are too many factor levels? {.unnumbered}
...
#### 4. What if there are _really_ too many factor levels? {.unnumbered}
